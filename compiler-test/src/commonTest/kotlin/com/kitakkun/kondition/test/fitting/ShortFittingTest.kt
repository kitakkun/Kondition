...
class ShortFittingTest {
    @Test
    fun testCoerceIn() {
        fun coerceInUpper(@CoerceIn(0, 10) value: Short) {
            assertEquals(10, value)
        }

        fun coerceInLower(@CoerceIn(0, 10) value: Short) {
    ...
    fun testCoerceAtMost() {
        fun coerceAtMost(@CoerceAtMost(0) value: Short) {
            assertEquals(0, value)
        }
    ...
    fun testCoerceAtLeast() {
        fun coerceAtLeast(@CoerceAtLeast(0) value: Short) {
            assertEquals(0, value)
        }
    ...
    fun testCoerceInDecimal() {
        fun coerceInUpper(@CoerceInDecimal(0.0, 10.0) value: Short) {
            assertEquals(10, value)
        }

        fun coerceInLower(@CoerceInDecimal(0.0, 10.0) value: Short) {
            assertEquals(0, value)
        }
    ...
    fun testCoerceAtMostDecimal() {
        fun coerceAtMost(@CoerceAtMostDecimal(0.0) value: Short) {
            assertEquals(0, value)
        }
    ...
    fun testCoerceAtLeastDecimal() {
        fun coerceAtLeast(@CoerceAtLeastDecimal(0.0) value: Short) {
            assertEquals(0, value)
        }
