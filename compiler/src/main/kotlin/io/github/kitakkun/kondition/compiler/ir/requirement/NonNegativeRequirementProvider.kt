...
class NonNegativeRequirementProvider : RequirementProvider {
    override val annotationClassId: ClassId = NonNegative::class.java.classId
    ...
    ): IrExpression? = irString("${valueParameter.name} in ${parentDeclaration.name} must be greater than or equals to 0.")
