...
class UpperCasedRequirementProvider : RequirementProvider {
    override val annotationClassId: ClassId = KonditionConsts.UpperCasedClassId
    override fun IrBuilderWithScope.produceErrorMessage(
        ...
        return irConcat().apply {
            ...
            addArgument(irString("must be uppercased. "))
